...
import { NearestToursController } from "../nearest-tours/nearest-tours.controller";
import { TourSearchController } from "../tour-search/tour-search.controller";
...
@Module({
  ...
  controllers: [ToursController, TourItemController, NearestToursController, TourSearchController]
})
